<div class="w-full max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6 text-center">Login Guru</h2>
    ...
    <form wire:submit.prevent="login" class="space-y-5">
        ...
        <div>
            ...
            <input wire:model.defer="email" type="email" id="email"
                   class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:ring focus:ring-teal-500 focus:border-teal-500 dark:bg-gray-700 dark:text-white"
        ...
        <button type="submit"
                class="w-full py-2 px-4 bg-teal-600 text-white font-semibold rounded-lg shadow hover:bg-teal-700 transition">
            Masuk
        </button>
    </form>
</div>
