<div class="p-6 bg-gradient-to-br from-gray-50 to-white min-h-screen">
    ...
    <ul class="grid grid-cols-2 md:grid-cols-4 gap-6">
        <li>
            <a href="{{ route('student.barcode.checkin') }}"
        ...
        <li>
            <a href="{{ route('student.barcode.gohome') }}"
        ...
        <li class="col-span-2 md:col-span-4 flex justify-center">
            <a href="{{route('student.seven.habbits')}}"
                ...
                <span class="text-purple-600 font-semibold text-center leading-tight">Kebiasaan Anak Indonesia Hebat</span>
            </a>
        </li>
    </ul>
</div>