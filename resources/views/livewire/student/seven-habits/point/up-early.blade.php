<div class="p-6 bg-gradient-to-br from-blue-100 via-white to-blue-50 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-md bg-white rounded-2xl shadow-lg p-6 border border-blue-200">
        <h2 class="text-xl font-bold text-blue-800 mb-4 text-center">
            Bangun Pagi - Check In
        </h2>
        ...
        <div id="countdownContainer" class="mb-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
            ...
            <div class="text-center text-xs text-orange-600 mt-1">
                Check-in akan tersedia lagi besok pagi
            </div>
        </div>
        ...
        <div class="text-center text-gray-600 mb-6">
            Klik tombol di bawah untuk mencatat jam bangunmu hari ini.<br>
        </div>

        <form action="{{ route('student.seven-habbits.up-early.save') }}" method="POST">
            @csrf
            <button type="submit"
                class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-lg shadow-md transition duration-200 transform hover:scale-105">
                ✅ Check In Sekarang
            </button>
        </form>
